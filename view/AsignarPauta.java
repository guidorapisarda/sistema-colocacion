...
public class AsignarPauta extends javax.swing.JFrame 
	{
		...
		private void initGUI() 
		{
				...
				getContentPane().add(codVendedor);
				codVendedor.setBounds(179, 76, 199, 23);
				...
				aceptar.setBounds(48, 150, 118, 23);
				aceptar.addActionListener(new ActionListener() 
				{
					...
					JOptionPane.showMessageDialog(null, "Pauta asignada a vendedor");
					}
				});
				...
				cancelar.setBounds(264, 150, 118, 23);
